...
import InfoUserScreen from "../page/Home/InfoUserScreen";
import RestartScreen from "../page/RestartScreen";
...
export default function DrawerContainer({navigation}) {
  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen name={'InfoUser'} component={InfoUserScreen} />
      <Drawer.Screen name={'Restart'} component={RestartScreen} />
    </Drawer.Navigator>
  );
}
